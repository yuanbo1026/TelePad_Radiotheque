package com.technisat.radiotheque.datenschutz;
...
public class DatenschutzActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	inflater.inflate(R.layout.activity_datenschutz, container);
    	
    	layout = (RelativeLayout)findViewById(R.id.datenschutz_layout);
    	title = (TextView)findViewById(R.id.datenschutz_title);
    	divider = (View)findViewById(R.id.datenschutz_divider);
    	content = (TextView)findViewById(R.id.datenschutz_content);
    	...
    	content.setTextColor(this.getResources().getColorStateList(
